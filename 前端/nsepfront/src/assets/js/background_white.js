const animation  =()=> {
    ...
    function get_config_option() {
        ...
        return {
            ...
            o: get_attribute(script, "opacity", 10000), //opacity
    ...
    // nowwidth =window.innerWidth ||document.documentElement.clientWidth ||document.body.clientWidth,
    // nowheight = window.innerHeight||document.documentElement.clientHeight || document.body.clientHeight;
    ...
    //当时鼠标位置存储，离开的时候或者过几秒，释放当前位置信息

    (window.onmousemove = function (e) {
        (e = e || window.event),
            (current_point.x = e.clientX),
            (current_point.y = e.clientY>70?e.clientY:null);
